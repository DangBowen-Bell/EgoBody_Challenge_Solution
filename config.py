...
# Path to EgoBody dataset
EGOBODY_ROOT = '/data/dbw/data/EgoBody/EgoSet'
# Path to the data generated from EgoBody dataset
DBW_ROOT = '/data/dbw/data/EgoBody/DBwSet'
# Path to the other data
OTHER_DATA_ROOT = '/data/dbw/code/EgoHPS/submit_code/data'
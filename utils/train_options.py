...
class TrainOptions():
    ...
    def __init__(self):
        ...
        io.add_argument('--data_root', type=str, default=config.EGOBODY_ROOT, help='')
        io.add_argument('--dbw_root', type=str, default=config.DBW_ROOT, help='')
        ...
        train.add_argument('--test_steps', type=int, default=500, help='Testing frequency during training')
        ...
        train.add_argument('--device_id', type=str, default='1', help='')
        train.add_argument('--use_aug', default=True, action='store_true', help='') 
        train.add_argument('--test_num_ratio', default=0.01, type=float, help='')
        train.add_argument('--use_full', default=True, action='store_true', help='')
        train.add_argument('--cutout_factor', default=0, type=float, help='')
        train.add_argument('--use_blur', default=False, action='store_true', help='')
